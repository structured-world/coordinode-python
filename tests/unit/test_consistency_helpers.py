...
# Proto stubs are generated by `make proto` and gitignored; skip the whole module
# when running on a fresh checkout that has not regenerated them yet.
pb = pytest.importorskip("coordinode._proto.coordinode.v1.replication.consistency_pb2")

from coordinode.client import (  # noqa: E402 — guarded import above
    _make_read_concern,
